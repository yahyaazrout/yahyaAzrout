...
html {line-height: 25px !important;}
body.swal2-toast-shown .swal2-container { width: 395px!important; }
.site-header { position: relative; padding: 50px 0 24px 0;}
.work-list { margin-left: 0px; }
.hero { padding-top: 15px;}
.work-list li { list-style: none; font-size: 0.9375em; color: #8c8c8c; }
.work-list li a { padding-bottom: 5px; font-size: 1.1875em; font-weight: 700; text-decoration: none;  border-bottom: 1px solid #b3b3b3; }
.work-list li a:hover {  border-bottom: 1px solid #333333; }
.features-inner { max-width: 500px !important; }
li.class-li {font-size: 14px; font-weight: bold; }
ul.skill-list.list-flat { list-style: none; font-size: 16px !important;}
li.title-li { font-size: 20px; font-weight: bold; color: rgb(255 255 255 / 66%);}
...
@media (min-width: 641px){
	.hero { padding-top: 5px !important; }
	.section-inner {padding-top: 35px !important; padding-bottom: 35px !important;}
	.site-header { position: relative; padding: 100px 0 24px 0;}
	.fixed-pos { right: 0; position: fixed; top: 260px; z-index: 999999;}
}
</style>
</head>
<body class="is-boxed">
	<div class="fixed-pos">
		<ul class="et_social_icons_container">
			<li class="et_social_facebook">
				<a href="tel:0674/62.98.37" class="et_social_share" rel="nofollow" data-social_name="facebook" data-post_id="130" data-social_type="share" data-location="sidebar" target=""> <i class="fas fa-phone-alt"></i><span class="et_social_overlay"></span>
		<span class="hide767">0674629837</span></a>
			</li>
		</ul>
	</div>
            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
							<h1 class="m-0 unit-80">Hi, I'm <span id="typed">Welcome</span></h1>
                    </div>
                </div>
            </div>
        </header>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <!-- <h1 class="hero-title mt-0 is-revealing"> Yahya Azrout</h1> -->
	                        <p class="hero-paragraph is-revealing">Full Stack developer, and technician support maintenance IT and networks.</p>
							<div class="hero-form field field-grouped is-revealing">
	                            <div class="control control-expanded">
	                                <input class="input" id="Email" type="email" name="email" placeholder="Your best email&hellip;" required>
	                            </div>
	                            <div class="control">
	                                <a class="button button-primary button-block" id="send">Notify Me</a>
	                            </div>
	                        </div>
						</div>
	                        ...
	                        <div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
		                                ...
		                                <h4 class="feature-title m-0">EDUCATION</h4>
									</div>
									<ul class="work-list">
										<li>2019 - 2021</li>
										<li class= "class-li">Diploma in multimedia development</li>
										<li>Full Stack developer</li>
									</ul>
	                                <hr>
									<ul class="work-list">
										<li>2017 - 2019</li>
										<li class= "class-li">Diploma in computer and network support maintenance.</li>
										<li>Networking technician.</li>
									</ul>
	                            </div>
	                        </div>
							<div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
		                                ...
		                                <h4 class="feature-title m-0">SKILLS</h4>
									</div>
									<ul class="skill-list list-flat">
										<li  class="title-li">Web Technology</li>
										<li>HTML / CSS / Javascript / Bootstrap / JQuery / Ajax / PHP / wordpress / SQL / MySQL </li>
										<hr>
										<li class="title-li">Networking</li>
										<li>Administration in Windows server,Linux.</li>
										<li>Configuration of Cisco routers and switches.</li>
									</ul>
	                            </div>
	                        </div>
						</div>
        ...
        <footer class="site-footer">
            ...
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    <div class="footer-copyright">&copy;&ensp;<span id="demo"></span>&ensp;Azrout Yahya, all rights reserved</div>
					<ul class="footer-social-links list-reset">
						<li>
							<a href="https://web.facebook.com/profile.php?id=100018518794154" target="_blank">
						...
						<li>
							<a href="https://twitter.com/yahiaazrout1" target="_blank">
						...
						<li>
							<a href="mailto:yahiaazrout@gmail.com">
	...
	<script>
		...
		<script>
			$(function () {
				$( "#send" ).click(function() {
					var email = $("#Email").val();
					if (email === "") { Swal.fire('No Email selected'); return; }
